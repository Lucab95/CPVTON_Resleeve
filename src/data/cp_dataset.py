...
class CPDataset(data.Dataset):
    ...
    Attributes:
        ...
        datamode: train or test
        stage: GMM or TOM or TOM+GMM
        data_list: file containing image and label list
        fine_height: fine height of image
        fine_width: fine width of image
        radius: radius of gaussian kernel
        data_path: path of image and cloth
        transform: transform of image

        im_names: image name list
        c_names: image cloth list
    """
    ...
    def __init__(self, opt):
        ...
        # base setting
        self.opt = opt 
        self.root = opt.dataroot # root directory of dataset
        self.datamode = opt.datamode  # train or test or self-defined
        self.stage = opt.stage  # GMM or TOM or TOM+GMM
        self.data_list = opt.data_list #file containing the path for person and cloth pictures
