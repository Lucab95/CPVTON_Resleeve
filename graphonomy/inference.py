...
from graphonomy.dataloader import custom_transforms as tr
...
def inference(net, img_path='', outpath_parse='./',outpath_parse_new='./', output_name='f', use_gpu=True):
    '''
    ...
    parsing_im.save(outpath_parse+'/{}'.format(output_name))
    cv2.imwrite(outpath_parse_new+'/{}'.format(output_name), results[0, :, :])
